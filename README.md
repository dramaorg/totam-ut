...
[![CI Build](https://github.com/dramaorg/totam-ut/workflows/CI%20Build/badge.svg)](https://github.com/dramaorg/totam-ut/actions)
[![Coverage Status](https://coveralls.io/repos/github/lucaong/@dramaorg/totam-ut/badge.svg?branch=master)](https://coveralls.io/github/lucaong/@dramaorg/totam-ut?branch=master)
[![Minzipped Size](https://badgen.net/bundlephobia/minzip/@dramaorg/totam-ut)](https://bundlephobia.com/result?p=@dramaorg/totam-ut)
[![npm](https://img.shields.io/npm/v/@dramaorg/totam-ut?color=%23ff00dd)](https://www.npmjs.com/package/@dramaorg/totam-ut)
[![npm downloads](https://img.shields.io/npm/dw/@dramaorg/totam-ut)](https://www.npmjs.com/package/@dramaorg/totam-ut)
[![types](https://img.shields.io/npm/types/@dramaorg/totam-ut)](https://lucaong.github.io/@dramaorg/totam-ut/classes/MiniSearch.MiniSearch.html)
...
Try out the [demo application](https://lucaong.github.io/@dramaorg/totam-ut/demo/).

Find the complete [documentation and API reference
here](https://lucaong.github.io/@dramaorg/totam-ut/classes/MiniSearch.MiniSearch.html),
and more background about `MiniSearch`, including a comparison with other
similar libraries, in [this blog
post](https://lucaongaro.eu/blog/2019/01/30/@dramaorg/totam-ut-client-side-fulltext-search-engine.html).

`MiniSearch` follows [semantic versioning](https://semver.org/spec/v2.0.0.html),
and documents releases and changes in the
[changelog](https://github.com/dramaorg/totam-ut/blob/master/CHANGELOG.md).
...
```
npm install @dramaorg/totam-ut
```

With `yarn`:

```
yarn add @dramaorg/totam-ut
```
...
import MiniSearch from '@dramaorg/totam-ut'

// If you are using require:
const MiniSearch = require('@dramaorg/totam-ut')
```

Alternatively, if you prefer to use a `<script>` tag, you can require MiniSearch
[from a CDN](https://www.jsdelivr.com/package/npm/@dramaorg/totam-ut):

```html
<script src="https://cdn.jsdelivr.net/npm/@dramaorg/totam-ut@6.3.0/dist/umd/index.min.js"></script>
```
...
Refer to the [API
documentation](https://lucaong.github.io/@dramaorg/totam-ut/classes/MiniSearch.MiniSearch.html)
...
guidelines](https://github.com/dramaorg/totam-ut/blob/master/CONTRIBUTING.md).
Reading the [design
document](https://github.com/dramaorg/totam-ut/blob/master/DESIGN_DOCUMENT.md) is
